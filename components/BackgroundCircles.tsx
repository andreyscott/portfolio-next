...
export default function BackgroundCircles({}: Props) {
  return (
    ...
    >
      ...
      <div className="absolute border border-[#4ff924] opacity-20 rounded-full h-[650px] w-[650px] mt-52 animate-pulse"></div>
      <div className="absolute border border-[#333333] opacity-20 rounded-full h-[800px] w-[800px] mt-52"></div>
    </motion.div>
  );
}
